...
# 4 ปีงบล่าสุด รวมปีงบปัจจุบัน 2569 — ราคาตลาดเก่าไม่สะท้อนปัจจุบัน (เงินเฟ้อ/ราคาวัสดุ).
# 2569 = งานสด recency-weight 1.0 ต้องถูกนับ (เดิมตัดทิ้ง → ESS พื้นที่บางขาด, กัญจน์ 2026-06-16)
RECENT_FY = ("2566", "2567", "2568", "2569")
