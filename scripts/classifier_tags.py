...
PROJECT_TYPE_RULES = [
    ...
    ("IT", [
        ...
        "โดเมนเนม", "พื้นที่เก็บข้อมูลออนไลน์",
    ]),
    ...
    ("บริการ", [
        ...
        "จ้างเหมาประกอบอาหาร", "ประกอบอาหารกลางวัน", "อาหารกลางวัน",
        "จ้างเหมาอาหาร", "ประอาหารกลางวัน",
    ...
    ("ก่อสร้าง", [
        ...
        # เพิ่ม 2025-05-20: pattern ที่พลาดบ่อย
        "บำรุงถนน", "ซ่อมสร้างถนน", "สัมประสิทธิ์ความเสียดทาน",
        "ขุดเจาะ", "น้ำบาดาล",
        "จัดสร้าง", "สร้างอาคาร",
        "เทลาน", "งานดิน",
        "ไหล่ทาง", "ขยายไหล่ทาง",
    ...
    ("อุปกรณ์", [
        ...
        "มิเตอร์น้ำ",
        # เพิ่ม 2025-05-20
        "พลังงานแสงอาทิตย์", "solar rooftop", "โซลาร์",
        "หม้อแปลงไฟฟ้า", "เครื่องกว้าน",
    ]),
    # วัสดุ
    ("วัสดุ", [
        ...
        # วัสดุก่อสร้างจำนวนมาก (ชลประทาน/โยธา)
        "คอนกรีตผสมเสร็จ", "กล่องลวดตาข่าย", "ลวดตาข่าย",
        "กระสอบพลาสติก", "ถังพลาสติก", "เข่งชนิด",
    ]),
]
