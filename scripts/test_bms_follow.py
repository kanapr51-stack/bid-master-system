...
# มีลิงก์ดูวิเคราะห์ราคาบน Bid Board
...
# inactive (ยังไม่ติดตาม) → มีลิงก์ Bid Board ด้วย (ดู preview ก่อนตัดสินใจ follow — Option C)
assert "ดูวิเคราะห์ราคา+คู่แข่งบน Bid Board" in h_inactive
assert "/portal/job?t=tok&pid=P1" in h_inactive
